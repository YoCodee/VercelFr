...
function Paket() {
  ...
  useEffect(() => {
    ...
    // Ensure gsap is loaded before animation
    if (!gsap) return;

    gsap.to(mask, {
      width: '100%',
      scrollTrigger: {
        trigger: triggerRef.current, // Replace with your actual trigger element
        start: 'top top', // Corrected start position
        scrub: true,
      },
    });

    // Cleanup function to prevent memory leaks
    return () => gsap.killTweensOf(mask);
  }, [maskRef]); // Dependency on maskRef
  ...
  return (
    <section className="scroll-section-outer">
      ...
      <div ref={triggerRef}>
      <div class="title1">
      <h1 class="font-serif text-4xl md:text-6xl font-bold max-w-80 md:max-w-xl text-cyan-500">Paket Wisata</h1>
    </div>
      <svg class="svg" viewBox="0 0 900 10" fill="none" xmlns="http://www.w3.org/2000/svg">
          ...
          <rect ref={maskRef} class="mask" x="0" y="-49" height="99" fill="black"/>
          </g>
          </svg>
        <div ref={sectionRef} className="scroll-section-inner">
          ...
          <section class="sec1 pin">
            <div className=""   >
          <p class="text-xl font-serif">Paket I (Rp 200.00,00)</p>
          <h1 class="font-serif">Paket Premium</h1>
          <div class="anim">
            <div className="flex">
          ...
          <div className="" data-aos="fade-down" data-aos-anchor-placement="top-top">
          <span class="anim text-xl font-serif" >Paket II (Rp 150.00,00)</span>
          <h1 class="anim font-serif">Paket Medium</h1>
          ...
          <div className="scroll-section" >
          <section class="sec3 pin" data-aos="fade-down" data-aos-anchor-placement="bottom-top"> 
            <div className="" >
          <span class="anim text-xl font-serif">Paket III (Rp 100.00,00)</span>
          <h1 class="anim font-serif">Paket Standard</h1>
          <div class="anim">
          <div className="flex">
          <svg className="w-4 h-4 text-yellow-300 me-1" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="currentColor" viewBox="0 0 22 20">
                    <path d="M20.924 7.625a1.523 1.523 0 0 0-1.238-1.044l-5.051-.734-2.259-4.577a1.534 1.534 0 0 0-2.752 0L7.365 5.847l-5.051.734A1.535 1.535 0 0 0 1.463 9.2l3.656 3.563-.863 5.031a1.532 1.532 0 0 0 2.226 1.616L11 17.033l4.518 2.375a1.534 1.534 0 0 0 2.226-1.617l-.863-5.03L20.537 9.2a1.523 1.523 0 0 0 .387-1.575Z"/>
